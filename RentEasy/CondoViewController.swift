...
class CondoViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        PropertyManager.shared.searchPropertiesByCategory(category: "Condo") { [weak self] (properties, error) in
...
extension CondoViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let firstImageUrlString = houses.imageUrls.first, let imageUrl = URL(string: firstImageUrlString) {
